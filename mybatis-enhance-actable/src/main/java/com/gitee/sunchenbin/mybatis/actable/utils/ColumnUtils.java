...
public class ColumnUtils {
    ...
    public static boolean isKey(Field field, Column column){
    ...
    public static boolean isAutoIncrement(Field field, Column column){
    ...
    public static boolean isNull(Field field, Column column){
