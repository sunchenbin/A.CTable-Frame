...
public final class ConstructorUtil{
     ...
     * <pre>
     * {@code
     * User user = ConstructorUtil.newInstance("com.sunchenbin.store.feilong.test.User") 将返回user 对象
     * 
     * 你还可以 
     * User user1 = ConstructorUtil.newInstance("com.sunchenbin.store.feilong.test.User", 100L); 返回 id 是100的构造函数
     * }
     * </pre>
     *
     * @param <T>
     *            t
     * @param className
     *            类得名称,比如 com.sunchenbin.store.feilong.test.User
     ...
     *            构造函数的参数值, 比如100L
     * @return the t
     * @see com.sunchenbin.store.feilong.core.lang.ClassUtil#toClass(Object...)
